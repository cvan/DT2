function CompatibilityCheck()
{
    ...
    {
        if (parseInt(browser.substr(7)) < 35)
        {
            if (!confirm("Your version of Chrome is to old to run this content. You need at least Chrome 35. Press Ok if you wish to continue anyways."))
                window.history.back();
        }
    }
